...
OBJECTS_LAT = rpmem_server.o simple_open_close.o simple_map_unmap.o simple_commit.o rpmem.o rpmem_common.o rpmem_protocol.o
...
simple_commit: simple_commit.o rpmem.o rpmem_common.o rpmem_protocol.o
	$(CC) $(CFLAGS) $(LDFLAGS) simple_commit.o rpmem.o rpmem_common.o rpmem_protocol.o -o $@
